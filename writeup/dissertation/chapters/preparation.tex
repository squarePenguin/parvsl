...
This is particularly important when designing the \ref{sec:org10be605}.

\section{Memory allocation}
\label{sec:org1af61e5}
...
and carefully \emph{joined} together to maintain the abstract model of continguous memory. Binary search
...
\section{Cheaney's algorithm}
\label{sec:org995855a}
...
Cheaney's algorithm is a method of stop-the-world copying garbage collection. The virtual \emph{heap} is divided into
...
\label{sec:org583b477}
\end{enumerate}
\section{Conservative GC}
\label{sec:org3723ce4}
