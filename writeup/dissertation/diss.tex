...
\hspace*{-13mm}
\includegraphics[width=30mm]{cambridge.eps}
% \includegraphics[width=6mm]{trinity.pdf}
\vspace*{-11mm}
...
Final code line count: & \bf 7129\footnotemark[2]        \\
Project Originator: & Dr. Arthur C. Norman                    \\
Supervisor:         & Dr. Arthur C. Norman                    \\
\end{tabular}
}

\footnotetext[1]{This word count was computed with the command: \texttt{texcount chapters/*.tex}.}
\footnotetext[2]{This line count only includes additions from the project starting point, obtained using \texttt{diff -u} and
counted using \texttt{cloc}, ignoring blank lines and comments.}
...
A number of people read this dissertation and provided useful comments
and corrections: Frank Stajano, Eberhard Schruefer,
Andrew Jeffery, Richie Yeung, Stefan Dascalu and Diana Tanase.
