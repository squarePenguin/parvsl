...
and I will document some of the uses in this chapter.
...
The garbage collector is /stop-the-world/. All running threads have to be paused before it can
initiate. Similarly, all threads must constantly check whether a garbage collection cycle was
initiated and act accordingly. T
